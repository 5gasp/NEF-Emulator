...
function api_get_moving_UEs() {
    ...
    var url = app.api_url + '/sim_ue_movement/state-ues';
...
function api_start_loop( ue ) {
    ...
    var url = app.api_url + '/sim_ue_movement/start-loop';
    var data = {
        "supi": ue.supi
    };
...
function api_stop_loop( ue ) {
    ...
    var url = app.api_url + '/sim_ue_movement/stop-loop';
    var data = {
        "supi": ue.supi
    };
...
function ui_set_loop_btn_status_for(ue) {
    var url = app.api_url + '/sim_ue_movement/state-loop/' + ue.supi;
